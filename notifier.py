    ...
    "«Сила характера — в ежедневной борьбе, а не в редких триумфах.» — (философия дисциплины)",
        ...
        self.schedule = {
            'monday': {
                ...
                'вечер': ['📖 Читать с Мартой', '📔 Заполни Эмоциональный дневник ( управляешь эмоциями)', '💻 Работать 2 часа над Pet Project', '🧠 20 минут с GROK психологом', '🇬🇧 Марта English', '🍽️ Марта моет посуду', '💊 Прими Магний перед сном ( Выключи стресс. )', '👨‍👩‍👧 Вечерняя благодарность (Семейная традиция)', '🧠 Включи Мозг']
            },
            'tuesday': {
                'утро': ['⚖️ Взвеситься' ( Цель 85 кг ), '💪 Сделай Зарядку ( кнопка „Старт" для твоей энергии)', '💊 Прими Витамины ( это топливо для мозга )', '💝 Сделай комплимент Марте и Саше ( твои девочки почувствуют себя важными и любимыми )', '📺 Посмотреть Амо блог на youtube', '🎓 English на Youtube 20 min', '🚀 Девиз дня: Ничего не бойся и не сдавайся!', '🧠 Включи Мозг'],
                'день': ['📚 Читать 25 минут (спорт для мозга:)', '🎯 Проверь Цели ( Цели — твой навигатор) ', '💪 Подтянуться min 12 раз', '💪 Упражнение на пресс 2 подхода min 16 раз', '🤐 Молчание золото. Не перебивай (Молчание строит доверие )'],
                'нельзя_день': ['❌ Ругаться матом (Мат это мусора - ты мусор ? )', '❌ Д (Слил энергию — слил фокус)', '🍷 Пить алкоголь (Он крадет твою энергию, деньги и внешность)'],
                'вечер': ['📖 Читать с Мартой', '📔 Заполни Эмоциональный дневник ( управляешь эмоциями)', '💻 Работать 2 часа над Pet Project', '🧠 20 минут с GROK психологом', '🇬🇧 Марта English', '🍽️ Аркаша моет посуду', '💊 Прими Магний перед сном ( Выключи стресс. )', '👨‍👩‍👧 Вечерняя благодарность (Семейная традиция)', '🧠 Включи Мозг']
            },
            'wednesday': {
                'утро': ['⚖️ Взвеситься' ( Цель 85 кг ), '💪 Сделай Зарядку ( кнопка „Старт" для твоей энергии)', '💊 Прими Витамины ( это топливо для мозга )', '💝 Сделай комплимент Марте и Саше ( твои девочки почувствуют себя важными и любимыми )', '📺 Посмотреть Амо блог на youtube', '🎓 English на Youtube 20 min', '🚀 Девиз дня: Ничего не бойся и не сдавайся!', '🧠 Включи Мозг'],
                'день': ['📚 Читать 25 минут (спорт для мозга:)', '🎯 Проверь Цели ( Цели — твой навигатор) ', '💪 Подтянуться min 12 раз', '💪 Упражнение на пресс 2 подхода min 16 раз', '🤐 Молчание золото. Не перебивай (Молчание строит доверие )'],
            ...
            'friday': {
                ...
                'нельзя_день': ['❌ Ругаться матом (Мат это мусора - ты мусор ? )', '❌ Д (Слил энергию — слил фокус)', '🍷 Пить алкоголь (Он крадет твою энергию, деньги и внешность)'],
                'вечер': ['📖 Читать с Мартой', '📔 Заполни Эмоциональный дневник ( управляешь эмоциями)', '💻 Работать 2 часа над Pet Project', '🧠 20 минут с GROK психологом', '🐦 Янтарные бусы - то символ свободы ', '🍽️ Марта моет посуду', '💊 Прими Магний перед сном ( Выключи стресс. )', '👨‍👩‍👧 Вечерняя благодарность (Семейная традиция)', '🍽️ Зачёт по чистоте комнаты в пятницу. Семейная традиция ', '🧠 Выключи Мозг']
            },
            'saturday': {
