...
class PersonalScheduleNotifier:
    def __init__(self):
        ...
        self.schedule = {
            ...
            'sunday': {
                'утро': ['💝 Комплимент Марте и Саше', '🐱', '📵 Семейные традиции - у тебя День без гаджетов', '👨‍👩‍👧 Семейные традиции. [Семейный совет](https://raw.githubusercontent.com/BRKME/Day/main/SS.txt)'],
