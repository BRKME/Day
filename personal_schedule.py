...
class PersonalScheduleNotifier:
    def __init__(self):
        ...
        self.wisdoms = [
            ...
            "Нет смысла никого прощать — проще не обижаться.",  # Исправлено
        ...
        self.schedule = {
            ...
            # ... добавь остальные дни по аналогии
            'friday': {
                'утро': ['⚖️ Весы', '💪 Зарядка', '💊 Прими Витамины', '💝 Комплимент Марте и Саше', '🐱', '📺 Посмотреть Амо блог на youtube', '🚀 Ничего не бойся и не сдавайся! - Девиз этого утра', '🧠 Афформация 5 минут'],
    ...
    def format_morning_message(self, date_str: str, day_of_week: str, schedule: dict):
        ...
        target_score = max(0, task_count - 1)  # Защита от отрицательных значений
